...
<section class="bg-blue-600 text-white py-20">
  ...
  <main class="py-12">
    <div class="container mx-auto px-6">
      <!-- Header Section -->
      <div class="mb-8">
        <h2 class="text-3xl font-semibold text-blue-600">Gestion des Etudiants</h2>
        <p class="text-gray-600">Liste et gestion des étudiants inscrits sur la plateforme.</p>
      </div>
      ...
      <div class="flex justify-between items-center mb-6">
        ...
        <button 
          ...
          <a href="{{ route('add_student') }}">Ajouter un Etudiant</a>
        </button>
      </div>
      ...
      @if($students->isEmpty())
      <small class="flex justify-center items-center text-2xl text-gray-600 font-bold ml-8">Aucun étudiant disponible pour vous, veuillez patienter l'ajout par des corps administratifs</small>
    @else
        <table class="min-w-full bg-white">
          ...
          <tbody class="text-gray-700 text-sm font-light">
            ...
            <tr class="border-b border-gray-200 hover:bg-gray-100">
              ...
              <td class="py-3 px-6 text-left">
                <span>{{$student->domaine->name}}</span>
              </td>
