...
<section class="bg-blue-600 text-white py-20">
  ...
  <main class="py-12">
    <div class="container mx-auto px-6">
      <!-- Header Section -->
      <div class="mb-8">
        <h2 class="text-3xl font-semibold text-blue-600">Gestion des superviseurs</h2>
        <p class="text-gray-600">Liste et gestion des superviseurs admits sur la plateforme.</p>
      </div>
      ...
      <div class="flex justify-between items-center mb-6">
        ...
        <button 
          ...
          <a href="{{ route('add_admin') }}">Ajouter un superviseur</a>
        </button>
      </div>
      ...
      @if($admins->isEmpty())
      <small class="flex justify-center items-center text-2xl text-gray-600 font-bold ml-8">Aucun superviseur disponible pour vous, veuillez patienter l'ajout par des corps administratifs</small>
    @else
