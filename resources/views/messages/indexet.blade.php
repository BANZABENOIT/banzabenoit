...
<div class="flex h-screen">
    ...
    <aside class="xl:w-1/3 bg-[#E3F2FD] border-r p-4 w-full">
        <h2 class="bg-blue-600 text-white text-2xl font-semibold mb-4 p-6 rounded-md">Contacts Disponibles</h2>
        ...
        <ul>
            @foreach($contacts as $contact)
                <li class="mb-2">
                    <a href="{{ route('messages.showet', $contact->id) }}" class="block p-2 text-lg rounded capitalize {{ $contact->online ? 'bg-green-100' : 'bg-[#E3F2FD]' }}">
