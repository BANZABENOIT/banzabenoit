...
<div class="flex h-screen">
    ...
    <main class="bg-white flex-1 flex flex-col">
        <header class="bg-blue-600 text-white flex justify-center items-center py-4 mb-4">
            <div>
                <div class="flex items-center border-gray-500 space-x-3 p-3">
        ...
        <form method="POST" action="{{ route('messages.store', $member->id) }}" class="border-t p-4 flex">
            @csrf
            <input type="text" name="content" class="bg-gray-100 text-gray-800 w-full p-2 border rounded" placeholder="Écrire un message..." required>
