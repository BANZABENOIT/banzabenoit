...
<div class="container mx-auto">
  <div class="container">
    <div class="flex justify-between items-center mb-8">
            <h2 class="text-3xl font-semibold text-blue-600 mb-6">Évaluations de mes cours</h2>
            <!-- Add Evaluation Button -->
            <div class="text-right px-4 py-2">
                <a href="{{ route('resultat') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Voir résultats</a>
            </div>
        </div>
